...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> searchAllProduct() async {
    ...
    try {
      var response = await http.post(Uri.parse(urlSearchProduct));
          ...
          children: <Widget>[
            Padding(
              ...
              child: TextField(
                ...
                onChanged: (search) => searchAllProduct(),
              ),
            ),
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const GridManShoes()));
                        },
                        child: SizedBox(
                          width: 60,
                          height: 80,
